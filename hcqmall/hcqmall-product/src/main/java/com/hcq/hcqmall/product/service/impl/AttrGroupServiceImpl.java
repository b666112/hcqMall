...
import com.hcq.hcqmall.product.service.AttrService;
...
import com.hcq.hcqmall.product.dao.AttrGroupDao;
import com.hcq.hcqmall.product.entity.AttrGroupEntity;
import com.hcq.hcqmall.product.service.AttrGroupService;
...
/*        LambdaQueryWrapper<AttrGroupEntity> w = new LambdaQueryWrapper<>();
        w.and((ob)->{
           ob.eq(null!=key,AttrGroupEntity::getAttrGroupId,key)
                   .or()
                   .like(null!=key,AttrGroupEntity::getAttrGroupName,key);
        });*/

/*        LambdaQueryWrapper<AttrGroupEntity> wrap = new LambdaQueryWrapper<>();
        wrap.eq(0!=catelogId,AttrGroupEntity::getCatelogId,catelogId);
        IPage<AttrGroupEntity> page1 = this.page(new Query<AttrGroupEntity>().getPage(params), wrap);
        return (PageUtils) page1;*/
