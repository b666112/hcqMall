...
import com.hcq.hcqmall.product.vo.BrandVo;
...
//        List<CategoryBrandRelationEntity> relationList = categoryBrandRelationService.list(new QueryWrapper<CategoryBrandRelationEntity>().eq("brand_id", brandId));
