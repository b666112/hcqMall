package com.hcq.hcqmall.cart.controller;
...
public class CartController {
    ...
    public String addCartItem(@RequestParam("skuId") Long skuId,
        ...
        return "redirect:http://cart.hcqmall.com/addToCartSuccessPage.html";
    }
    ...
    public String checkItem(@RequestParam(value = "skuId") Long skuId,
        ...
        return "redirect:http://cart.hcqmall.com/cart.html";
    ...
    public List<CartItemVo> getCurrentUserCartItemByHu(){
        return cartService.getUserCartItemsByHu();
    }
}
